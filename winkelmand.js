...
let products = {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        quantity.innerHTML = "<input class=\"winkelmand_hoeveelheid_nummer\" type=\"number\" value=\"1\" min=\"1\" max=\"99\">";
        remove_button.innerHTML = "<img src=\"assets/delete.png\" alt=\"delete\">";
